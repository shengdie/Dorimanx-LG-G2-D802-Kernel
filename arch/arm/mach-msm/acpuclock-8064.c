...
static struct scalable scalable[] __initdata = {
	...
	[CPU2] = {
		...
		.vreg[VREG_MEM]  = { "krait2_mem", 1500000 },
		.vreg[VREG_DIG]  = { "krait2_dig", 1500000 },
	...
	[CPU3] = {
		...
		.vreg[VREG_MEM]  = { "krait3_mem", 1500000 },
		.vreg[VREG_DIG]  = { "krait3_dig", 1500000 },
...
static struct l2_level l2_freq_tbl[] __initdata __initdata = {
	...
	/* L2 Level 17 is for 8064ab only */
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(9), 1400000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(9), 1350000 },
#ifdef CONFIG_OC_ULTIMATE
	{ 1, {  1890000, HFPLL, 1, 0x45 }, L2(9), 1375000 },
	{ 1, {  1944000, HFPLL, 1, 0x46 }, L2(9), 1400000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(9), 1275000 },
#ifdef CONFIG_OC_ULTIMATE
	{ 1, {  1890000, HFPLL, 1, 0x45 }, L2(9), 1325000 },
	{ 1, {  1944000, HFPLL, 1, 0x46 }, L2(9), 1350000 },
#endif
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(9), 1200000 },
        { 1, {  1836000, HFPLL, 1, 0x44 }, L2(9), 1250000 },
#ifdef CONFIG_OC_ULTIMATE
	{ 1, {  1890000, HFPLL, 1, 0x45 }, L2(9), 1275000 },
	{ 1, {  1944000, HFPLL, 1, 0x46 }, L2(9), 1300000 },
#endif
	{ 0, { 0 } }
};
